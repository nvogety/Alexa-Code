...
var APP_ID = "amzn1.ask.skill.XXXXXXXXXXXXX"; //replace with "amzn1.echo-sdk-ams.app.[your-unique-value-here]";
    ...
    ParticleIntent: function (intent, session, response) {
		...
		if(op.length > 0){
			...
			makeParticleRequest(sparkHst, sparkPath, "", accessToken, function(resp){
				...
				response.tellWithCard(sensor + " is " + json.return_value + ((sensor == "temperature") ? "° Celsius" : "%"), "Particle", "Particle!");
			});
		}
